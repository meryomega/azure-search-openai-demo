...
import logo from "../../assets/USP_Zdrowie_New_Logo.png";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <img src={logo} aria-hidden="true" aria-label="Chat logo" />
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput clearOnSend placeholder="Zadaj nowe pytanie" disabled={isLoading} onSend={question => makeApiRequest(question)} />
                    </div>
                </div>
